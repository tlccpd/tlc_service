	...
	function jobAppGo() {
		try{
			...
			if(agt.indexOf("android") > -1) {
				...
				location.href = "https://play.google.com/store/apps/details?id=com.tlcpub.net.tlc_ver";
				return;
	...
	function getJobLogin() {
		try{
			...
			if(agt.indexOf("android") != -1) {
				...
				location.href = "https://play.google.com/store/apps/details?id=com.tlcpub.net";
				return;
			}
		}catch(ErrObj){
